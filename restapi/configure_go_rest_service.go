...
import (
	...
	"github.com/afritzler/go-rest-service/restapi/operations/pet"
	"github.com/afritzler/go-rest-service/restapi/operations/store"
	"github.com/afritzler/go-rest-service/restapi/operations/user"
)

// This file is safe to edit. Once it exists it will not be overwritten

//go:generate swagger generate server --target .. --name go-rest-service --spec ../api/swagger.yaml

func configureFlags(api *operations.GoRestServiceAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.GoRestServiceAPI) http.Handler {
