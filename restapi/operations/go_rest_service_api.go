...
// NewGoRestServiceAPI creates a new GoRestService instance
func NewGoRestServiceAPI(spec *loads.Document) *GoRestServiceAPI {
	return &GoRestServiceAPI{
...
/*GoRestServiceAPI This is a sample server Petstore server.  You can find out more about     Swagger at [http://swagger.io](http://swagger.io) or on [irc.freenode.net, #swagger](http://swagger.io/irc/).      For this sample, you can use the api key `special-key` to test the authorization     filters. */
type GoRestServiceAPI struct {
	spec            *loads.Document
...
func (o *GoRestServiceAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *GoRestServiceAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *GoRestServiceAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *GoRestServiceAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *GoRestServiceAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *GoRestServiceAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *GoRestServiceAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the GoRestServiceAPI
func (o *GoRestServiceAPI) Validate() error {
...
func (o *GoRestServiceAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *GoRestServiceAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *GoRestServiceAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *GoRestServiceAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *GoRestServiceAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the go rest service API
func (o *GoRestServiceAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *GoRestServiceAPI) initHandlerCache() {
...
func (o *GoRestServiceAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
